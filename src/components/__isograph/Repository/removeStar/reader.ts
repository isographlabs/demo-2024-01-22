...
export type ReadFromStoreType = Repository__removeStar__param;
...
export type Repository__removeStar__param = {
  id: string,
};
...
const artifact: ReaderArtifact<ReadFromStoreType, Repository__removeStar__param, ReadOutType> = {
  kind: "ReaderArtifact",
